...
import { ExternalLink, X, Upload, FileText, CheckCircle2, Loader2, Sparkles } from "lucide-react";
...
export function ApplyButtons({ jobTitle, company }: ApplyButtonsProps) {
  ...
  return (
    <>
      ...
      {/* ── Bottom "Apply for this position" button ── */}
      <div className="pt-2">
